import { Forth, ForthNodeExtensions, Flash8_16, Flash8_32, Flash16_16, Flash32_32 } from '../index.js';
...
memClass = Flash8_32; // Uncomment this to simulate a chip with separate Rom and Ram (like an Arduino).
