...
#define XT_BYTEMASK 0x9c /* BYTEMASK*/
#define XT_IMED 0x98 /* IMED*/
#define XT_COMP 0x94 /* COMP*/
...
/* 0x1a2: COMPILE-ONLY */ F_tokenDoList, XT_COMP, XT_setHeaderBits, XT_EXIT, 
/* 0x1aa: IMMEDIATE */ F_tokenDoList, XT_IMED, XT_setHeaderBits, XT_EXIT, 
...
/* 0x1fa4 BYTEMASK */ XT_BYTEMASK, 0x1fb6, 0x4208, 0x5459, 0x4d45, 0x5341, 0x4b,
/* 0x1fb2 IMED */ XT_IMED, 0x1fc0, 0x4904, 0x454d, 0x44,
/* 0x1fbc COMP */ XT_COMP, 0x1fca, 0x4304, 0x4d4f, 0x50,
...
#define FROMRAMADDR(x) (CELLTYPE(x << CELLSHIFT) | RAM0)
#define FROMROMADDR(x) CELLTYPE(x << CELLSHIFT)
